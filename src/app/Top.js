...
function Top() {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50">
      {/* الشريط الأحمر المتحرك (progress bar) */}
      <div
      ...
      >
        ...
        {/* الشريط الأحمر المتحرك في أسفل الهيدر الكبير */}
        <div
          className="absolute left-0 bottom-0 h-[3px] bg-[#854d0e] transition-all duration-200"
